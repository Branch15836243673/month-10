...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="{{route('month.register')}}" method="post" enctype="multipart/form-data">
        @csrf
	<div class="row cl">
	...
	<div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>图像上传：</label>
            <div class="formControls col-xs-8 col-sm-9">
